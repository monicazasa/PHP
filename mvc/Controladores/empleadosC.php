	...
	public function MostrarEmpleadosC(){
		...
		foreach ($respuesta as $key => $value) {
			...
			echo'<tr>
						...
						<td><a href="index.php?ruta=editar&id='.$value["id"].'"><button>Editar</button></td>


						<td><a href="index.php?ruta=empleados&idB='.$value["id"].'"><button>Borrar</button></td>
				</tr>';
...
//Editar Empelado 
	...
	public function EditarEmpleadoC(){
		...
		$respuesta = EmpleadosM::EditarEmpeladoM($datosC, $tablaBD); 
